...
const APP_ROUTES = ['home', 'ai', 'list', 'rfq', 'chat', 'detail', 'mypage', 'admin', 'terms', 'privacy', 'report', 'search', 'landing', 'grants', 'community'];
...
function App() {
  ...
  return (
    <>
      ...
      {route === 'community' && <CommunityPage onNav={nav} authed={authed}/>}
